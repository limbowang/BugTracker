...
(function ($) {
    ...
    $(function () {
        ...
        $("select[name='topic']").selectpicker({style: 'btn-primary', menuStyle: 'dropdown-inverse'});
        ...
        $('.btn-delete').on('click', function () {
            ...
            $('#form-delete').attr('action', url.substring(0, url.indexOf('admin')) + $(this).attr('data-item-id').replace('-', '/'));
        });
    });
