...
@section('content')
{{ Form::model($post, array('method'=>'PUT', 'route' => array('bbs.update', $post->id), 'class' => 'form-container signin-form')) }}
...
<div class="form-group">
    ...
    {{ Form::text('title', Input::old('title'), array('id' => 'post-title', 'class' => 'form-control form-field',
...
<div class="form-group">
    ...
    {{ Form::textarea('content', Input::old('content'), array('id' => 'post-content', 'class' => 'form-control
    form-field', 'placeholder' => '请输入2~255个字符')) }}
